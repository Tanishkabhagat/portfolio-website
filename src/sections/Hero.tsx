...
export const HeroSection = () => {
  return <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
    <div className="absolute inset-0" style={{ maskImage: "linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1) 10%, rgba(0, 0, 0, 1) 70%, rgba(0, 0, 0, 0))" }}>  
    ...
    <div className="container">
      ...
      <div className="flex flex-col items-center md:flex-row justify-center mt-8 gap-4">
        ...
        <button className="inline-flex items-center border gap-2 border-white bg-white text-gray-800 h-12 rounded-xl px-6
        ">
          <span>👋</span>
